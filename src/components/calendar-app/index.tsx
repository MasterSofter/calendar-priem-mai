...
export default function CalendarApp({calendarData, filter, className, locale}: CalendarProps): JSX.Element {
  ...
  return (
    <div className={className}>
      <div className="position-relative zindex-3 calendar-nav d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-lg-6 pb-lg-6 pt-lg-4">
        <Title/>
        <MonthNavigation selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth} locale={locale}/>
      </div>
