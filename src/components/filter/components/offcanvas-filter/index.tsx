...
export function OffcanvasFilter({locale, show, setShow, setFilter} : OffcanvasFilterProps) :JSX.Element {
      ...
      <Offcanvas className="w-100 h-100" scroll={true} backdrop={false} placement="end" show={show} onHide={handleClose}>
        <OffcanvasBody className="py-0 px-0" >
          <div className="d-lg-none">
            <div onClick={handleClose} className="sticky-top d-flex flex-row justify-content-start align-items-center py-4 pt-5 ms-4 ms-lg-0">
            ...
            <Filter setFilter={setFilter} className="col d-flex flex-column justify-content-start"/>
          </div>
        </OffcanvasBody>
      </Offcanvas>
    </>
